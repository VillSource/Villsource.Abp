...
namespace Villsource.Abp.Migrations
{
    ...
    [Migration("20260312081205_indexing2")]
    partial class indexing2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.State", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.StateMachine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.StateMachineTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.Transition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VillsourceTransitions", (string)null);
                });
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.State", b =>
                {
                    b.HasOne("Villsource.Abp.Workflow.Workflows.StateMachine", "StateMachine")
                        .WithMany("States")
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.StateMachineTransaction", b =>
                {
                    b.HasOne("Villsource.Abp.Workflow.Workflows.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("Villsource.Abp.Workflow.Workflows.Transition", b =>
                {
                    b.HasOne("Villsource.Abp.Workflow.Workflows.State", "FromState")
                        .WithMany()
                    ...
                    b.HasOne("Villsource.Abp.Workflow.Workflows.State", "ToState")
                        .WithMany()
                        .HasForeignKey("ToStateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Villsource.Abp.Workflow.Workflows.TransitionCondition", "Condition", b1 =>
                        {
                            b1.Property<Guid>("TransitionId")
                                .HasColumnType("uuid");

                            b1.Property<int>("ActorType")
                                .HasColumnType("integer");

                            b1.Property<string>("DepartmentId")
                                .HasColumnType("text");

                            b1.Property<int?>("RequireAtLestApprover")
                                .HasColumnType("integer");

                            b1.Property<bool?>("RequireTopLevel")
                                .HasColumnType("boolean");
                            ...
                            b1.HasKey("TransitionId");

                            b1.ToTable("VillsourceTransitions");
