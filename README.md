...
* Check the `ConnectionStrings` in `appsettings.json` file under the `Villsource.Abp` project and change it if you need.
...
* `Villsource.Abp`: ASP.NET Core API host application.
* `Villsource.Abp.Tests`: Test project for the application.
...
> `b4528d14-01f2-40c5-bd2c-bd46b1ebb7ec` is the password of the certificate, you can change it to any password you want.
