...
public class AbpDbMigrationService : ITransientDependency
{
    ...
    private readonly AbpDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public AbpDbMigrationService(
        IDataSeeder dataSeeder,
        AbpDbSchemaMigrator dbSchemaMigrator,
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName, AbpConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName, AbpConsts.AdminPasswordDefaultValue)
        );
    }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "Villsource.Abp");
    }
