...
```bash
ng build workflow --watch
```

## Code scaffolding

Run `ng generate component component-name --project workflow` to generate a new component in the library.
...
```bash
npm install @villsource.Abp/workflow
```

2. Import the module in your application:
```typescript
import { WorkflowModule } from '@villsource.Abp/workflow';
